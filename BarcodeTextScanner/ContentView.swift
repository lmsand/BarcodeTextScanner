...
struct ContentView: View {
    ...
    private var mainView: some View {
        DataScannerView(recognizedItems: $vm.recognizedItems,
                        ...
                        recognizesMultipleItems: vm.recognizesMulitipleItems)
        ...
        .onChange(of: vm.recognizesMulitipleItems, { vm.recognizedItems = [] } )
    }
    ...
    private var headerView: some View {
        VStack {
            HStack {
                ...
                Toggle("Scan multiple", isOn: $vm.recognizesMulitipleItems)
            }.padding(.top)
